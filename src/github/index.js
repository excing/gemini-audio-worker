...
import { handleGithubOauthCallback, handleGithubOauthRefresh, handleGithubOauthHook } from './oauth.js';
...
export async function handleGithubRequest(request, env, url) {
  switch (url.pathname) {
    ...
    case '/api/github/auth/hook':
      return handleGithubOauthHook(request, env, url);
    default:
      return null;
  }
}
